...
const createOrder = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield order_service_1.OrderService.createOrder(payload, user === null || user === void 0 ? void 0 : user.id);
...
const updateOrder = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = req.user;
    const payload = req.body;
    const result = yield order_service_1.OrderService.updateOrder(id, user, payload);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_1.default.OK,
