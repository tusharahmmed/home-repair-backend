...
const updateOrder = (id, user, payload) => __awaiter(void 0, void 0, void 0, function* () {
    // for customers
    if (user.role === client_1.USER_ROLE.user) {
        ...
        if ((orderDetails === null || orderDetails === void 0 ? void 0 : orderDetails.userId) === user.id) {
...
const deleteOrder = (id, user) => __awaiter(void 0, void 0, void 0, function* () {
    // for customers
    if (user.role === client_1.USER_ROLE.user) {
        const orderDetails = yield prisma_1.default.order.findUnique({
            where: {
