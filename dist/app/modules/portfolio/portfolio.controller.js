...
const insertIntoDb = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield portfolio_service_1.PortfolioService.insertIntoDb(
      JSON.parse(data),
      file
    );
...
const getAllDocument = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const filters = (0, pick_1.default)(
      req.query,
      portfolio_contant_1.PORTFOLIO_FILTERS_FIELDS
    );
    const result = yield portfolio_service_1.PortfolioService.getAllDocument(
      options,
      filters
    );
    (0, sendResponse_1.default)(res, {
...
const getDocumentById = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result = yield portfolio_service_1.PortfolioService.getDocumentById(
      id
    );
    (0, sendResponse_1.default)(res, {
      success: true,
...
const getDocumentByCategory = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield portfolio_service_1.PortfolioService.getDocumentByCategory(
        categoryId,
        options
      );
    (0, sendResponse_1.default)(res, {
...
const updateDocumentById = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const file = req === null || req === void 0 ? void 0 : req.file;
    const result =
      yield portfolio_service_1.PortfolioService.updateDocumentById(
        id,
        JSON.parse(data),
        file
      );
...
const deleteDocumentById = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result =
      yield portfolio_service_1.PortfolioService.deleteDocumentById(id);
    (0, sendResponse_1.default)(res, {
      success: true,
      statusCode: http_status_1.default.OK,
