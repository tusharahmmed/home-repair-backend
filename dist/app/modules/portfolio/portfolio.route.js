...
router.post(
  ...
  portfolio_controller_1.PortfolioController.insertIntoDb
);
router.get(
  '/:categoryId/category',
  portfolio_controller_1.PortfolioController.getDocumentByCategory
);
router.patch(
  '/:id',
  ...
  (0, auth_1.default)(client_1.USER_ROLE.super_admin, client_1.USER_ROLE.admin),
  FileUploadHelper_1.FileUploadHelper.upload.single('file'),
  portfolio_controller_1.PortfolioController.updateDocumentById
);
router.delete(
  '/:id',
  (0, auth_1.default)(client_1.USER_ROLE.super_admin, client_1.USER_ROLE.admin),
  portfolio_controller_1.PortfolioController.deleteDocumentById
);
