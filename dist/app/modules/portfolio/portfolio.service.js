...
const insertIntoDb = (payload, file) =>
...
const getAllDocument = (options, filters) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (search) {
      andConditions.push({
        OR: portfolio_contant_1.PORTFOLIO_SEARCH_FIELDS.map(field => ({
          [field]: {
            contains: search,
            mode: 'insensitive',
          },
    ...
    const total = yield prisma_1.default.portfolio.count({
      where: whereConditions,
    });
...
const updateDocumentById = (id, payload, file) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const serviceDetails = yield prisma_1.default.portfolio.findUnique({
      where: { id },
    });
    if (
      file &&
      (serviceDetails === null || serviceDetails === void 0
        ? void 0
        : serviceDetails.image)
    ) {
      const response = yield FileUploadHelper_1.FileUploadHelper.replaceImage(
        serviceDetails.image,
        file
      );
      if (!response) {
...
const deleteDocumentById = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.$transaction(tx =>
      __awaiter(void 0, void 0, void 0, function* () {
        const isExistHomeBanner = yield tx.portfolio.findUnique({
          where: { id },
          select: { image: true },
        });
        if (
          isExistHomeBanner === null || isExistHomeBanner === void 0
            ? void 0
            : isExistHomeBanner.image
        ) {
          yield FileUploadHelper_1.FileUploadHelper.destroyToCloudinary(
            isExistHomeBanner.image
          );
        }
